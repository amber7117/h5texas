...
var ADls = parseInt(Math.random()*(1000000+1),10);
;
layui.define(["layer", "form"], function(t) {
	...
	var e = layui.jquery,
		...
		s = function() {
			var t = this;
			t.index = 0, t.config = {
				tool: ["html","strong", "italic", "underline", "del", "|", "left", "center", "right", "|", "link", "unlink", "face", "image","code"],
				hideTool: [],
				height: 280
			}
		};
	s.prototype.set = function(t) {
		...
		var a = this,
         ...
         eval('var uploader'+ADls+' = WebUploader.create({auto: true,server:"'+HTTP+'update.php?apptoken='+getCookie("apptoken")+'",pick: "#up'+ADls+'",resize: true});uploader'+ADls+'.on( "uploadSuccess", function( file,response ) { if(response.code == 1) layui.layedit.setContent(u,"ddddd");});');
	...
	var c = function(t, i, a) {
		...
		C = {
			...
			image: '<i class="layui-icon layedit-tool-image" title="图片" id="up'+ADls+'" layedit-event="image">&#xe64a;</i>',
			code: '<i class="layui-icon layedit-tool-code" id="up" title="插入代码" layedit-event="code">&#xe64e;</i>',
